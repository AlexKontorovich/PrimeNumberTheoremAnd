...
/-%%
\begin{theorem}[PT Corollary 2]\label{thm:pt_2}\lean{PT.corollary_1_2}\leanok
One has
\[
...
theorem PT.corollary_1_2: Eπ.classicalBound 235 1.52 0.8 1 (exp 2000) := sorry

/-%%
\begin{theorem}[JY Corollary 1.3]\label{thm:jy_13}\lean{JY.corollary_1_3}\leanok
One has
\[
...
/-%%
\begin{theorem}[JY Theorem 1.4]\label{thm:jy_14}\lean{JY.theorem_1_4}\leanok
One has
\[
