...
✓ `li2_symmetric_lower` - PROVEN via LeanCert.Examples.Li2Verified
✓ `li2_symmetric_upper` - PROVEN via LeanCert.Examples.Li2Verified
○ `li2_symmetric_eq_li2` - connects symmetric form to principal value (PNT#764)

The numerical bounds on the symmetric form are complete. The remaining sorry
connects the symmetric form to the principal value definition of li(2).
...
theorem g_intervalIntegrable (a b : ℝ) (ha : 0 < a) (hb : b < 1) (hab : a ≤ b) :
  ...
  -- The integrability follows from continuity on (0,1)
  -- g is continuous on (0,1) since log(1±t) ≠ 0 there
  sorry
