...
theorem mid_row4 : ∀ x ∈ Set.Icc (exp (10:ℝ)) (exp (20000:ℝ)),
  ...
  mid_of P4 1.76 1 1.5 (by norm_num [P4]) (by norm_num) (by norm_num) (by norm_num [P4])
    (by have hrhs : (((P4.c64 * 64 : ℚ)):ℝ) = 3179/5000 := by norm_num [P4]
        rw [hrhs, div_le_iff₀ sqrtR5_pos]; nlinarith [sqrtR5_lb])
    (by rw [Real.rpow_one]; norm_num [P4])
    allCells_checked_row4
...
theorem floor_buthe4 : ∀ x ∈ Set.Icc (Real.exp 5) (Real.exp 10),
    Eπ x ≤ admissible_bound 1.76 1 1.5 5.5666305 x :=
  FloorButhe.floor_buthe_of_curve rhsE4 1.76 1 1.5 slabs_checked4 rhsE4_le_rowcurve
...
theorem floor_row4 : ∀ x ∈ Set.Icc (exp (3:ℝ)) (exp (10:ℝ)),
  ...
  · exact FKS2.TrustedNumerics.row4_floor x ⟨h3, (not_le.mp h5).le⟩
