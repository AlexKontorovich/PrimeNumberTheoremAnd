...
private lemma exp_neg_4925_2_lt : Real.exp (-(4925/2 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_2475_lt : Real.exp (-(2475 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_4975_2_lt : Real.exp (-(4975/2 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
...
private lemma exp_neg_9800_3_lt : Real.exp (-(9800/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_9850_3_lt : Real.exp (-(9850/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_3300_lt : Real.exp (-(3300 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_9950_3_lt : Real.exp (-(9950/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_10000_3_lt : Real.exp (-(10000/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_3400_lt : Real.exp (-(3400 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_10400_3_lt : Real.exp (-(10400/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_10600_3_lt : Real.exp (-(10600/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_3600_lt : Real.exp (-(3600 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_11000_3_lt : Real.exp (-(11000/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_11200_3_lt : Real.exp (-(11200/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_3800_lt : Real.exp (-(3800 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_11600_3_lt : Real.exp (-(11600/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_11800_3_lt : Real.exp (-(11800/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_4000_lt : Real.exp (-(4000 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_12200_3_lt : Real.exp (-(12200/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_12400_3_lt : Real.exp (-(12400/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_4200_lt : Real.exp (-(4200 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_12800_3_lt : Real.exp (-(12800/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
private lemma exp_neg_13000_3_lt : Real.exp (-(13000/3 : ℝ)) < 1e-100 := LogTables.exp_neg_lt_1e_neg_100 (by norm_num)
