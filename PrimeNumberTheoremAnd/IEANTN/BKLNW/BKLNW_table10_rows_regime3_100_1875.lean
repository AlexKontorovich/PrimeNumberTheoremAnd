...
private lemma exp_neg_250_lt : Real.exp (-(250 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_800_3_lt : Real.exp (-(800/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_300_lt : Real.exp (-(300 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1000_3_lt : Real.exp (-(1000/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_350_lt : Real.exp (-(350 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_400_lt : Real.exp (-(400 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_450_lt : Real.exp (-(450 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1400_3_lt : Real.exp (-(1400/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_500_lt : Real.exp (-(500 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1600_3_lt : Real.exp (-(1600/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_600_lt : Real.exp (-(600 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_2000_3_lt : Real.exp (-(2000/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_750_lt : Real.exp (-(750 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_800_lt : Real.exp (-(800 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_850_lt : Real.exp (-(850 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1725_2_lt : Real.exp (-(1725/2 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_875_lt : Real.exp (-(875 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1775_2_lt : Real.exp (-(1775/2 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_900_lt : Real.exp (-(900 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1825_2_lt : Real.exp (-(1825/2 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_925_lt : Real.exp (-(925 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1875_2_lt : Real.exp (-(1875/2 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1000_lt : Real.exp (-(1000 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_3200_3_lt : Real.exp (-(3200/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_3400_3_lt : Real.exp (-(3400/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1150_lt : Real.exp (-(1150 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_3500_3_lt : Real.exp (-(3500/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_3550_3_lt : Real.exp (-(3550/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_1200_lt : Real.exp (-(1200 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_3650_3_lt : Real.exp (-(3650/3 : ℝ)) < 1e-100 := by interval_decide
private lemma exp_neg_3700_3_lt : Real.exp (-(3700/3 : ℝ)) < 1e-100 := by interval_decide
