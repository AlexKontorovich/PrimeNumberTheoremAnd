...
private lemma rpow_neg_nat (n : ℕ) :
  ...
  rw [rpow_neg (by positivity : (0 : ℝ) ≤ 10),
    rpow_natCast, one_div]

private lemma alpha_eq :
    Inputs.default.α = 193571378 / (10 : ℝ) ^ 16 := by
  change 1.93378e-8 * BKLNW_app.table_8_margin =
    193571378 / (10 : ℝ) ^ 16
...
private lemma a2_20_exp_lower :
    (1.4262 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) * f (exp (20 : ℝ)) := by
...
private lemma a2_25_exp_lower :
    (1.2195 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) * f (exp (25 : ℝ)) := by
  simpa [f_eq_leancert_f] using
...
private lemma a2_30_exp_lower :
    (1.1210 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) * f (exp (30 : ℝ)) := by
  simpa [f_eq_leancert_f] using
...
private lemma a2_35_exp_lower :
    (1.07086 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) * f (exp (35 : ℝ)) := by
  simpa [f_eq_leancert_f] using
...
private lemma a2_40_exp_lower :
    (1.04319 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) * f (exp (40 : ℝ)) := by
  simpa [f_eq_leancert_f] using
...
private lemma a2_43_exp_lower :
    (1.03252 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) * f (exp (43 : ℝ)) := by
  simpa [f_eq_leancert_f] using
...
private lemma a2_100_lower :
    (1.0002420 : ℝ) ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
      max (f (exp 100))
        (f ((2 : ℝ) ^ (⌊(100 : ℝ) / log 2⌋₊ + 1))) := by
  rw [floor_100]
  calc (1.0002420 : ℝ)
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            f (exp 100) := a2_100_exp_lower
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            max (f (exp 100))
              (f ((2 : ℝ) ^ (144 + 1))) := by
        gcongr; exact le_max_left _ _
...
private lemma a2_150_lower :
    (1.000003748 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) *
        max (f (exp 150))
          (f ((2 : ℝ) ^ (⌊(150 : ℝ) / log 2⌋₊ + 1))) := by
  rw [floor_150]
  calc (1.000003748 : ℝ)
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            f (exp 150) := a2_150_exp_lower
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            max (f (exp 150))
              (f ((2 : ℝ) ^ (216 + 1))) := by
        gcongr; exact le_max_left _ _
...
theorem a2_150_mem_Icc :
    (1 + 193571378 / (10 : ℝ) ^ 16) *
        max (f (exp 150))
          (f ((2 : ℝ) ^ (⌊(150 : ℝ) / log 2⌋₊ + 1))) ∈
      Set.Icc (1.000003748 : ℝ)
        ((1.000003748 : ℝ) + (1 : ℝ) / 10 ^ 8) :=
  ⟨a2_150_lower, a2_150_upper⟩

private lemma floor_200 : ⌊(200 : ℝ) / log 2⌋₊ = 288 := by
  rw [Nat.floor_eq_iff
    (by positivity : (0 : ℝ) ≤ 200 / log 2)]
  constructor
  · rw [le_div_iff₀ (log_pos one_lt_two)]; interval_decide
  · rw [div_lt_iff₀ (log_pos one_lt_two)]; interval_decide
...
private lemma a2_200_lower :
    (1.00000007713 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) *
        max (f (exp 200))
          (f ((2 : ℝ) ^ (⌊(200 : ℝ) / log 2⌋₊ + 1))) := by
  rw [floor_200]
  calc (1.00000007713 : ℝ)
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            f (exp 200) := a2_200_exp_lower
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            max (f (exp 200))
              (f ((2 : ℝ) ^ (288 + 1))) := by
        gcongr; exact le_max_left _ _
...
theorem a2_200_mem_Icc :
    (1 + 193571378 / (10 : ℝ) ^ 16) *
        max (f (exp 200))
          (f ((2 : ℝ) ^ (⌊(200 : ℝ) / log 2⌋₊ + 1))) ∈
      Set.Icc (1.00000007713 : ℝ)
        ((1.00000007713 : ℝ) + (1 : ℝ) / 10 ^ 9) :=
  ⟨a2_200_lower, a2_200_upper⟩

private lemma floor_250 : ⌊(250 : ℝ) / log 2⌋₊ = 360 := by
  rw [Nat.floor_eq_iff
    (by positivity : (0 : ℝ) ≤ 250 / log 2)]
  constructor
  · rw [le_div_iff₀ (log_pos one_lt_two)]; interval_decide
  · rw [div_lt_iff₀ (log_pos one_lt_two)]; interval_decide
...
private lemma a2_250_lower :
    (1.00000002025 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) *
        max (f (exp 250))
          (f ((2 : ℝ) ^ (⌊(250 : ℝ) / log 2⌋₊ + 1))) := by
  rw [floor_250]
  calc (1.00000002025 : ℝ)
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            f (exp 250) := a2_250_exp_lower
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            max (f (exp 250))
              (f ((2 : ℝ) ^ (360 + 1))) := by
        gcongr; exact le_max_left _ _
...
theorem a2_250_mem_Icc :
    (1 + 193571378 / (10 : ℝ) ^ 16) *
        max (f (exp 250))
          (f ((2 : ℝ) ^ (⌊(250 : ℝ) / log 2⌋₊ + 1))) ∈
      Set.Icc (1.00000002025 : ℝ)
        ((1.00000002025 : ℝ) + (1 : ℝ) / 10 ^ 9) :=
  ⟨a2_250_lower, a2_250_upper⟩

private lemma floor_300 : ⌊(300 : ℝ) / log 2⌋₊ = 432 := by
  rw [Nat.floor_eq_iff
    (by positivity : (0 : ℝ) ≤ 300 / log 2)]
  constructor
  · rw [le_div_iff₀ (log_pos one_lt_two)]; interval_decide
  · rw [div_lt_iff₀ (log_pos one_lt_two)]; interval_decide
...
private lemma a2_300_lower :
    (1.00000001937 : ℝ) ≤
      (1 + 193571378 / (10 : ℝ) ^ 16) *
        max (f (exp 300))
          (f ((2 : ℝ) ^ (⌊(300 : ℝ) / log 2⌋₊ + 1))) := by
  rw [floor_300]
  calc (1.00000001937 : ℝ)
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            f (exp 300) := a2_300_exp_lower
      _ ≤ (1 + 193571378 / (10 : ℝ) ^ 16) *
            max (f (exp 300))
              (f ((2 : ℝ) ^ (432 + 1))) := by
        gcongr; exact le_max_left _ _
...
theorem cor_5_1_rem' (b a₂b : ℝ) (m : ℕ)
  ...
  · rw [show (1 + 2.420e-4 : ℝ) = (1.0002420 : ℝ) from
      by norm_num, rpow_neg_nat]
    exact a2_100_mem_Icc
  · rw [show (1 + 3.748e-6 : ℝ) = (1.000003748 : ℝ) from
      by norm_num, rpow_neg_nat]
    exact a2_150_mem_Icc
  · rw [show (1 + 7.713e-8 : ℝ) = (1.00000007713 : ℝ)
      from by norm_num, rpow_neg_nat]
    exact a2_200_mem_Icc
  · rw [show (1 + 2.025e-8 : ℝ) = (1.00000002025 : ℝ)
      from by norm_num, rpow_neg_nat]
    exact a2_250_mem_Icc
  · rw [show (1 + 1.937e-8 : ℝ) = (1.00000001937 : ℝ)
      from by norm_num, rpow_neg_nat]
