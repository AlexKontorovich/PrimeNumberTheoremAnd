...
For additional context, see https://leanprover.zulipchat.com/#narrow/channel/423402-PrimeNumberTheorem.2B/topic/Let.20us.20formalize.20an.20appendix
-/
...
-- $|C_{\sigma,\rho}|\leq |C_{\sigma,\pm 1/2\pi}|\leq 0.176\sigma +0.246$. While $c_\rho$ is optimal, $C_{\sigma,\rho}$ need not be --
