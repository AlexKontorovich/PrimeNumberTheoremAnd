...
@[blueprint
  ...
  (latexEnv := "theorem")]
theorem theorem_2a {x : ℝ} (hx1 : 11 < x)
    (hx2 : x ≤ 10 ^ 19) :
...
@[blueprint
  ...
  (latexEnv := "theorem")]
theorem theorem_2b {x : ℝ} (hx1 : 1423 ≤ x)
    (hx2 : x ≤ 10 ^ 19) :
...
@[blueprint
  ...
  (latexEnv := "theorem")]
theorem theorem_2c {x : ℝ} (hx1 : 1 ≤ x)
    (hx2 : x ≤ 10 ^ 19) :
...
@[blueprint
  ...
  (latexEnv := "theorem")]
theorem theorem_2d {x : ℝ} (hx1 : 2 ≤ x)
    (hx2 : x ≤ 10 ^ 19) :
...
@[blueprint
  ...
  (latexEnv := "theorem")]
theorem theorem_2e {x : ℝ} (hx1 : 2 ≤ x)
    (hx2 : x ≤ 10 ^ 19) :
    li x - pi x ≤
      (sqrt x / log x) *
        (1.95 + 3.9 / log x + 19.5 / (log x) ^ 2) := by
  sorry
...
@[blueprint
  ...
  (statement := /--
    ...
    $\mathrm{li}(x) - \pi(x) > 0$. -/)
  (latexEnv := "theorem")]
theorem theorem_2f {x : ℝ} (hx1 : 2 ≤ x)
    (hx2 : x ≤ 10 ^ 19) :
